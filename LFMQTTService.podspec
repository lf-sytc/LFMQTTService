...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lf_sytc@hotmail.com/LFMQTTService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lf_sytc@hotmail.com' => 'lf_sytc@hotmail.com' }
  s.source           = { :git => 'https://github.com/lf_sytc@hotmail.com/LFMQTTService.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'LFMQTTService' => ['LFMQTTService/Assets/*.png']
  # }
